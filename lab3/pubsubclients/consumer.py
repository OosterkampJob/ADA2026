...
if __name__ == '__main__':
    ...
    create_subscription("qualified-city-486215-i5", "diabetes_res", "diabetes_res_sub")
    pull_message(project="qualified-city-486215-i5", subscription="diabetes_res_sub")  # replace your project id
